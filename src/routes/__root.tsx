...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "The Fertility Garden — Trusted IVF Consultancy in Vadodara" },
      {
        name: "description",
        content:
          "The Fertility Garden offers expert IVF consultancy, personalized fertility guidance and compassionate support for hopeful parents in Vadodara, Gujarat.",
      },
      { name: "author", content: "The Fertility Garden" },
      { property: "og:title", content: "The Fertility Garden — IVF Consultancy in Vadodara" },
      {
      ...
      { name: "twitter:title", content: "The Fertility Garden — IVF Consultancy" },
      {
        name: "twitter:description",
        content:
          "Guiding you towards the joy of parenthood with expert IVF consultation & support. Call 9879441983.",
      },
    ],
    links: [
